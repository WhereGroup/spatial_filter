...
from .filters import FilterDefinition, Predicate, RemoteFilterStrategy
...
class FilterController(QObject):
    ...
    def setFilterFromLayer(self, layer):
        ...
        if not filterDefinition.crs.isValid():
            filterDefinition.crs = layer.crs()
    ...
    def setRemoteFilterStrategy(self, strategy: RemoteFilterStrategy):
        self.currentFilter.remote_strategy = strategy.value
        self.refreshFilter()
